  ...
  return (
    ...
    >
      <Card>
        ...
        // className="px-5"
        >
          Contact us to reserve a time, add dietary restrictions, or simply to
          ask question. We do our best to accommodate all needs.
        </Card.Text>
        <Card.Text
        // className="px-5"
        >
          You can reach us by phone (555) 555-5555, by email
          example@address.com, or simply send us a message using this form:
        </Card.Text>
